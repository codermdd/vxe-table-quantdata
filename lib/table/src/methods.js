...
var Methods = {
  ...
  restoreCustomStorage: function restoreCustomStorage() {
    ...
    var isVisible = isAllStorage || storage && storage.visible || $toolbar && $toolbar.customOpts.storage;
  ...
  analyColumnWidth: function analyColumnWidth() {
    ...
    var defaultWidth = columnOpts.width || columnWidth;
  ...
  triggerCheckRowEvent: function triggerCheckRowEvent(evnt, params, value) {
    ...
    if (!checkMethod || checkMethod({
      ...
      this.handleSelectRow(params, value);
      var records = this.getCheckboxRecords();
